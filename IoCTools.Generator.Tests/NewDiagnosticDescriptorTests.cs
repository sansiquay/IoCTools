...
public sealed class NewDiagnosticDescriptorTests
{
    ...
    [InlineData("IOC100", nameof(DiagnosticDescriptors.AutoDepOpenMultiArity))]
    [InlineData("IOC101", nameof(DiagnosticDescriptors.AutoDepOpenNonGeneric))]
    [InlineData("IOC102", nameof(DiagnosticDescriptors.AutoDepOpenConstraintViolation))]
    ...
    [InlineData(nameof(DiagnosticDescriptors.AutoDepOpenMultiArity), "ioc100")]
    [InlineData(nameof(DiagnosticDescriptors.AutoDepOpenNonGeneric), "ioc101")]
    [InlineData(nameof(DiagnosticDescriptors.AutoDepOpenConstraintViolation), "ioc102")]
