...
Plans:
- [ ] 02-01-PLAN.md — Add IOC090-094 diagnostic descriptors and extend ManualRegistrationValidator with typeof() detection
- [ ] 02-02-PLAN.md — Create integration tests for typeof() diagnostics and add sample project examples
- [ ] 02-03-PLAN.md — Add CLI infrastructure: AnsiColor utility, OutputContext abstraction, --json/--verbose flags, color-coded printers
...
- [ ] 02-05-PLAN.md — Add ioc-tools suppress command with DiagnosticCatalog, .editorconfig generation, --live mode
...
| 2. typeof() Diagnostics and CLI | 0/5 | Not started | - |
